...
import "./Japan.css"
import J1 from "./offers3.jpg";
import J2 from "./offers3.jpg";
import J3 from "./offers3.jpg";
import J4 from "./offers3.jpg";
import J5 from "./offers3.jpg";
import J6 from "./offers3.jpg";
import J7 from "./offers3.jpg";
import J8 from "./offers3.jpg";
  ...
  render() {
    return (
      ...
      <div className='citypic'>
          <img src={J4} alt="Tokyo" width="280px" height="200px" className='japimg'/>
       <h4 className='japh4'>Tokyo</h4>
      </div>

      <div className='citypic'>
          <img src={J5} alt="Hiroshima" width="280px" height="200px" className='japimg'/>
       <h4 className='japh4'>Hiroshima</h4>
      </div>

      <div className='citypic'>
          <img src={J6} alt="Kobe" width="280px" height="200px" className='japimg'/>
       <h4 className='japh4'>Kobe</h4>
      </div>

      <div className='citypic'>
          <img src={J7} alt="Kyoto" width="280px" height="200px" className='japimg'/>
      ...
      <div className='citypic'>
          <img src={J2} alt="Tokyo" width="280px" height="200px"/>
       
      </div>

      <div className='citypic'>
          <img src={J3} alt="Hiroshima" width="280px" height="200px"/>
      ...
      <div className='citypic'>
          <img src={J1} alt="Kyoto" width="280px" height="200px"/>
        </div>
    </div>
    <br/>
